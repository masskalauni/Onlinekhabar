    ...
    <div class="container-fluid trend">
        <div class="row">
            <div class="col-lg-9">
                    ...
                    <ul><?php
                $newsCat = get_terms(['taxonomy' => 'project_categories', 'hide_empty' => false]);
                foreach ($newsCat as $newsCatData) {
                ?>
                        <li>
                            <span><a href="<?php echo get_term_link($newsCatData->term_id, 'project_categories'); ?>"><?php echo $newsCatData->name; ?></a></span>
                        </li>
                        <?php } ?>
                    </ul>
